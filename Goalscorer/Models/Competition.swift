...
extension Competition {
    ...
    // UEFA
    static let laLiga =                     Competition(name: "La Liga",                        association: .rfef)
    static let premierLeague =              Competition(name: "Premier League",                 association: .fa)
    static let serieA =                     Competition(name: "Serie A",                        association: .figc)
    static let bundesliga =                 Competition(name: "Bundesliga",                     association: .dfb)
    static let ligue1 =                     Competition(name: "Ligue 1",                        association: .fff)
    static let russianPremierLeague =       Competition(name: "Russian Premier League",         association: .rfs)
    static let primeiraLiga =               Competition(name: "Primeira Liga",                  association: .fpf)
    static let belgianFirstDivisionA =      Competition(name: "Belgian First Division A",       association: .kbvb)
    static let ukrainianPremierLeague =     Competition(name: "Ukrainian Premier League",       association: .ffu)
    static let superLig =                   Competition(name: "Süper Lig",                      association: .tff)
    static let eredivisie =                 Competition(name: "Eredivisie",                     association: .knvb)
    static let austrianFootballBundesliga = Competition(name: "Austrian Football Bundesliga",   association: .ofb)
    // CONMEBOL
    static let campeonatoBrasileiroSerieA = Competition(name: "Campeonato Brasileiro Série A",  association: .cbf)
    static let argentinePrimeraDivision =   Competition(name: "Argentine Primera División",     association: .afa)
    // CONCACAF
    static let majorLeagueSoccer =          Competition(name: "Major League Soccer season",     association: .ussf)
    static let ligaMX =                     Competition(name: "Liga MX season",                 association: .fmf)
    // AFC
    static let aLeague =                    Competition(name: "A-League",                       association: .ffa)
    static let qatarStarsLeague =           Competition(name: "Qatar Stars League",             association: .qfa)
    static let uaeProLeague =               Competition(name: "UAE Pro-League",                 association: .uaefa)
    static let persianGulfProLeague =       Competition(name: "Persian Gulf Pro League",        association: .ffiri)
    static let saudiProfessionalLeague =    Competition(name: "Saudi Professional League",      association: .saff)
    static let chineseSuperLeague =         Competition(name: "Chinese Super League",           association: .cfa)
    static let kLeague1 =                   Competition(name: "K League 1",                     association: .kfa)
    static let j1League =                   Competition(name: "J1 League",                      association: .jfa)
}
