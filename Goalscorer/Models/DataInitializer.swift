    ...
    func bulkInsert() {
        for association in associations {
            for competition in association.competitionsTemp {
                ...
                for allTimeTopScorer in competition.overallTopScorersTemp {
        ...
        try! realm.write {
            ...
            realm.add(associations.flatMap { $0.competitionsTemp }.flatMap { $0.overallTopScorersTemp })
...
let associations = [
    Association(name: "FIFA", regionCode: "WW", latitude: 47.381389, longitude: 8.574444,
                competitions: [Competition(name: "FIFA World Cup",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/FIFA_World_Cup_top_goalscorers#Overall_top_goalscorers")]),
                               Competition(name: "FIFA Club World Cup",
                                           topScorers: [TopScorer(season: "2018", header: "Goalscorers"),
                                                        ...
                                                        TopScorer(season: "2006", header: "Goalscorers")],
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/List_of_FIFA_Club_World_Cup_goalscorers#Overall_top_goalscorers")])],
                players: []),
    Association(name: "UEFA", regionCode: "CEU", latitude: 46.371009, longitude: 6.23103,
                competitions: [Competition(name: "UEFA Euro",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/List_of_UEFA_European_Championship_goalscorers#Overall_top_goalscorers")]),
                               Competition(name: "UEFA Champions League",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/List_of_European_Cup_and_UEFA_Champions_League_top_scorers#All-time_top_scorers")]),
    ...
    Association(name: "Spain", regionCode: "ES", latitude: 40.383333, longitude: -3.716667,
                competitions: [Competition(name: "La Liga",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/List_of_La_Liga_top_scorers#All-time_top_scorers")])],
    ...
    Association(name: "England", regionCode: "GB-ENG", latitude: 51.5, longitude: -0.116667,
                competitions: [Competition(name: "Premier League",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/List_of_Premier_League_players_with_100_or_more_goals#Players")])],
    ...
    Association(name: "Italy", regionCode: "IT", latitude: 41.9, longitude: 12.483333,
                competitions: [Competition(name: "Serie A",
                                           topScorers: [TopScorer(season: "2018–19", header: "Top goalscorers"),
                                                        ...
                                                        TopScorer(season: "2008–09", header: "Top goalscorers"),
                                                        TopScorer(season: "2007–08", header: "Top goalscorers")],
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/List_of_Serie_A_players_with_100_or_more_goals#List")])],
    ...
    Association(name: "Germany", regionCode: "DE", latitude: 50.116667, longitude: 8.683333,
                competitions: [Competition(name: "Bundesliga",
                                           topScorers: [TopScorer(season: "2018–19", header: "Top scorers"),
                                                        ...
                                                        TopScorer(season: "2008–09", header: "Top goalscorers"),
                                                        TopScorer(season: "2007–08", header: "Top goalscorers")],
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/Bundesliga#Top_scorers")])],
    ...
    Association(name: "France", regionCode: "FR", latitude: 48.8567, longitude: 2.3508,
                competitions: [Competition(name: "Ligue 1",
                                           topScorers: [TopScorer(season: "2018–19", header: "Top goalscorers")],
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/List_of_Ligue_1_records_and_statistics#Goalscorers")])],
    ...
    Association(name: "CONMEBOL", regionCode: "CSA", latitude: -25.260556, longitude: -57.516111,
                competitions: [Competition(name: "Copa América",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/Copa_Am%C3%A9rica_records_and_statistics#Goalscoring")]),
                               Competition(name: "Copa Libertadores",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/Copa_Libertadores_records_and_statistics#All-time_top_scorers")])],
                players: []),
    Association(name: "Brazil", regionCode: "BR", latitude: -22.908333, longitude: -43.196389,
                competitions: [Competition(name: "Campeonato Brasileiro Série A",
                                           topScorers: [TopScorer(season: "2018", header: "Top scorers")],
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/Campeonato_Brasileiro_S%C3%A9rie_A_top_scorers#All-time_top_scorers")])],
    ...
    Association(name: "Argentina", regionCode: "AR", latitude: -34.603333, longitude: -58.381667,
                competitions: [Competition(name: "Argentine Primera División",
                                           topScorers: [TopScorer(season: "2018–19", header: "Top goalscorers")],
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/List_of_Argentine_Primera_Divisi%C3%B3n_top_scorers#All-time_Topscorers")])],
    ...
    Association(name: "CONCACAF", regionCode: "CNA", latitude: 25.773, longitude: -80.138,
                competitions: [Competition(name: "CONCACAF Gold Cup",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/CONCACAF_Gold_Cup_records_and_statistics#Top_20_goal_leaders")]),
                               Competition(name: "CONCACAF Champions League",
                                           topScorers: [TopScorer(season: "2018", header: "Top goalscorers")],
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/CONCACAF_Champions%27_Cup_and_Champions_League_records_and_statistics#All-time_top_scorers")])],
                players: []),
    ...
    Association(name: "CAF", regionCode: "CAF", latitude: 29.938126, longitude: 30.91398,
                competitions: [Competition(name: "Africa Cup of Nations",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/Africa_Cup_of_Nations_records_and_statistics#Overall_top_goalscorers")]),
    ...
    Association(name: "OFC", regionCode: "COC", latitude: -36.840556, longitude: 174.74,
                competitions: [Competition(name: "OFC Nations Cup",
                                           topScorers: [TopScorer(season: "2016", header: "Goalscorers"),
                                                        TopScorer(season: "2012", header: "Goalscorers"),
                                                        TopScorer(season: "2008", header: "Goalscorers")],
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/OFC_Nations_Cup_records_and_statistics#Overall_top_goalscorers")]),
                               Competition(name: "OFC Champions League",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/Oceania_Club_Championship_and_OFC_Champions_League_records_and_statistics#All-time_top_scorers")])],
                players: []),
    Association(name: "AFC", regionCode: "CAS", latitude: 3.056296, longitude: 101.688919,
                competitions: [Competition(name: "AFC Asian Cup",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/AFC_Asian_Cup_records_and_statistics#Overall_top_goalscorers")]),
                               Competition(name: "AFC Champions League",
                                           ...
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/Asian_Club_Championship_and_AFC_Champions_League_records_and_statistics#All-time_top_goalscorers")])],
                players: []),
    ...
    Association(name: "Japan", regionCode: "JP", latitude: 35.683333, longitude: 139.766667,
                competitions: [Competition(name: "J1 League",
                                           topScorers: [TopScorer(season: "2018", header: "Top scorers")],
                                           overallTopScorers: [OverallTopScorer(url: "https://en.wikipedia.org/wiki/J.League_records_and_statistics#Ranks")])],
                players: [])
]
